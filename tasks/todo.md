...
**Favicon** (queued — research done, kickoff written, agent dispatched 2026-06-30)
- [ ] **`assets/logo.png` → favicon across all browsers + devices** — User approved black/white glass VK variant. Source file already at `prototypes/assets/logo.png` (1.35MB). Requirements: display correctly in Chrome, Firefox, Safari, Edge + iOS Safari (Apple touch icon) + Android Chrome (manifest icon) + PWA contexts + bookmark bar + share previews. **Kickoff at `tasks/kickoff-favicon.md`** (Hermes-authored, dispatched by Vishal 2026-06-30). Don't create SVGs from scratch — derive all formats from the source PNG.

**Topbar logo** (queued — parent task, 3 sub-places identified 2026-06-30)
