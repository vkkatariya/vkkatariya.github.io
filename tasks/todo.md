...
- [~] Apply topbar liquid-glass effect to all widgets on all pages — Homepage 16, Projects 11, Roadmap 38 (excl. timeline), About 19, /me 1. Branch `feat/widget-liquid-glass`. 2026-06-20. Use left/center pill formula: blur 40px saturate 180%, border rgba(255,255,255,.16).
